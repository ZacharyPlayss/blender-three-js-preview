...
class EXPORT_SCENE_OT_glb(bpy.types.Operator):
    """Export Blender scene as GLB and refresh preview"""
    ...
    def execute(self, context):
        ...
        self.report({'INFO'}, f"Scene exported to {filepath}")
...
class REFRESH_THREEJS_OT_operator(bpy.types.Operator):
    """Refresh THREE.js preview in browser (backup)"""
    bl_idname = "wm.refresh_threejs_preview"
    bl_label = "Refresh THREE.js Preview"
